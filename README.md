...
* **[RF02] Validação de Credenciais:** Integração e checagem de acessos via banco de dados MySQL (driver MySQLi).
...
* **[RF08] CRUD de Entidades (Usuários, Trens, Rotas, Sensores):** Telas e formulários para cadastro, listagem, visualização e exclusão.
...
##  Mapeamento de Interfaces (CRUD UI)

Abaixo estão listadas as interfaces desenvolvidas e padronizadas para cada entidade do sistema:

| Entidade | Tela de Listagem / Exibição | Tela de Form (Cadastro / Edição) |
| :--- | :--- | :--- |
| **Usuários** | `public/usuarios.php` | `public/usuario-form.php` |
| **Trens** | `public/trens.php` | `public/trem-form.php` |
| **Rotas** | `public/rotas.php` | `public/rota-form.php` |
| **Sensores** | `public/sensores.php` | `public/sensor-form.php` |
...
* Os ritos do **Scrum** mantêm a equipe em sincronia quanto aos prazos e prioridades dos Requisitos Funcionais.
 ...
 **Link do GitHub Projects (Kanban):** (https://github.com/jaime168-arch/SA_1/projects)

---

##  Padrões de Código (Style Guide)

Para garantir a consistência e organização do repositório, a equipe estabeleceu as seguintes regras de desenvolvimento:

### 1. Nomenclatura de Arquivos e Pastas
* **Arquivos Web, PHP, JS e CSS:** Padrão `kebab-case` em minúsculas (ex: `usuario-form.php`, `teste-conexao.php`, `style.css`).
...
* **Comentários:** Utilizados para explicar regras de negócio complexas ou blocos de script SQL.
...
* **Backend:** PHP (Comunicação via extensão **MySQLi**).
...
├── public/                  # Telas e formulários PHP do sistema
